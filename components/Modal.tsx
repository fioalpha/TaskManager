        ...
        <Modal
            ...
            <Modal.Footer>
                <div className="button col-12">
                    ...
                    <span
                        onClick={() => id && doDelete ? doDelete() : closeModal()}>{id ? "Excluir" : "Cancelar"}</span>
                </div>
            </Modal.Footer>
        </Modal>
    );
...
export const ModalSuccess: NextPage<ModalSuccessProps> = ({
                                                              isShow,
                                                              title,
                                                              message,
                                                              isLoaderShow,
    ...
    if (isLoaderShow) {
        bodyContent = <Spinner animation="border"/>
    } else {
        bodyContent = <span>{message}</span>
    }
